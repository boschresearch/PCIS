...
class ResNetBackbone(Backbone):
    ...
    def validate(self):
        ...
        """
        allowed_backbones = ['resnet50',  'resnet101', 'resnet152', 'resNEXT50', 'inception']
...
def resnet_retinanet(num_classes, backbone='resnet50', inputs=None, modifier=None, **kwargs):   #inputs=None,
    ...
    if backbone == 'resnet50':
        resnet = keras_resnet.models.ResNet50(inputs, include_top=False, freeze_bn=True, use_bias=False)
        resnet.summary()
