"""
This source code is from https://github.com/cocodataset/cocoapi
Copyright (c) 2014, Piotr Dollar and Tsung-Yi Lin
This source code is licensed under the BSD (TwoClauseLicense) found in the
...
class COCOeval:
    ...
    def evaluate(self, id_setup):
        ...
        catIds = p.catIds if p.useCats else [-1]   #breakes here
